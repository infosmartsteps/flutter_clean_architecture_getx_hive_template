...
import '../datasources/clints/i_clients_data_source.dart';
import '../models/client_model.dart';

class ClientsRepositoryImpl extends IClientsRepository {
  final IClientsDataSource iClientsDataSource;

  ClientsRepositoryImpl({required this.iClientsDataSource});

  @override
  Future<Either<String, List<ClientEntity>>> getClients() async {
    try {
      final response = await iClientsDataSource.getClients();
      if (!response.success) {
