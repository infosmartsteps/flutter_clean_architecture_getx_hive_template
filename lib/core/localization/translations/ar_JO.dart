...
const Map<String, String> ar_JO = {
  ...
  'save': 'حفظ',
  "Property_Information_Link": "رابط بيانات العقار",
  "Property_name": "اسم القطعة العقارية",
  ...
  'Client_information_Link': 'رابط بيانات العميل',
  "Under_Follow-up": "قيد المتابعة",
  "Requires_Follow-up": "يتطلب المتابعة",
  "Follow-up_Completed": "تم تأكيد متابعة الفرصة",
  "Follow-up_Canceled": "تم إلغاء متابعة الفرصة	",
  "canceled": "تم الإلغاء!",
  "success": "تم بنجاح!",
  ...
  'redirecting_to_maps': 'يتم التوجيه إلى تطبيق الخرائط',
  'sharing': 'مشاركة',
  'property_shared': 'تم مشاركة معلومات العقار',
