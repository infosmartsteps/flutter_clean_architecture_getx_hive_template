...
import '../../domain/repositories/i_opportunities_repository.dart';
import '../datasources/opportunities/i_opportunities_data_source.dart';
import '../models/opportunity_model.dart';

class OpportunitiesRepositoryImpl extends IOpportunitiesRepository {
  final IOpportunitiesDataSource iOpportunitiesDataSource;

  OpportunitiesRepositoryImpl({required this.iOpportunitiesDataSource});

  @override
  Future<Either<String, List<OpportunityEntity>>> getOpportunities() async {
    try {
      final response = await iOpportunitiesDataSource.getOpportunities();
      if (!response.success) {
      ...
      final List<OpportunityModel> models = OpportunityModel.fromJsonList(opportunities);
      final List<OpportunityEntity> entities = OpportunityEntity.fromModelList(models);
